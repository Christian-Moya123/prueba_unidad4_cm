...
public class ProductoRepositoryImpl implements IProductoRepository{
	...
	public ProductoStockDto bucarPorCodigoBarras(String codigo) {
		...
		Query jpqlQuery = this.entityManager.createQuery("SELECT new com.uce.edu.demo.sencillo.ProductoStockDto(p.codigoBarras, p.nombre, p.stock, p.categoria) FROM Producto p where p.codigoBarras = :datoCodigo");
